    ...
    <div className="mx-auto max-w-3xl px-4 py-8 space-y-6">
      ...
      <div className="text-sm text-slate-400 leading-relaxed space-y-4">
        ...
        <section className="space-y-2">
          <h2 className="text-base font-semibold text-slate-300">수집 정보</h2>
          <p>
        ...
        <section className="space-y-2">
          <h2 className="text-base font-semibold text-slate-300">광고 및 분석</h2>
          <p>
        ...
        <section className="space-y-2">
          <h2 className="text-base font-semibold text-slate-300">쿠키</h2>
          <p>
